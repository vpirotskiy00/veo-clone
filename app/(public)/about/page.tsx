        ...
        <div className='container mx-auto px-6 py-12'>
          ...
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-gray-600 dark:text-gray-300 max-w-4xl mx-auto leading-relaxed'>
              ...
              AI-powered video generation accessible to everyone. From
              individual creators to large enterprises, we provide the tools to
              bring any vision to life with unprecedented realism and quality.
            </p>
          </div>
          ...
          <div className='mb-16'>
            <Card className='p-8 md:p-12 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-950/20 dark:to-purple-950/20'>
              ...
              <p className='text-lg text-center max-w-3xl mx-auto leading-relaxed'>
                ...
                imagination into reality. We believe that everyone should have
                access to professional-quality video creation tools, regardless
                of technical expertise or budget constraints.
              </p>
            </Card>
          </div>
